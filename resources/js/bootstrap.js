...
axios.interceptors.request.use(
    ...
    config => {
        ...
        //EXEMPLOS USANDO ARRAY E SEM ARRAY - AS 02 FORMAS ABAIXO FUNCIONAM
        config.headers['Accept'] = 'application/json'
       
        //splitando o conteudo do cookie e trazendo o que começa com token=
    ...
    error => {
        console.log('Erro na requisição interceptor', error)
...
axios.interceptors.response.use(
    ...
    error => {
        ...
        if (error.response.status == 401 && error.response.data.message == 'Token has expired'){
            console.log('Vamos fazer uma nova requisição para o refresh')
