...
class ProdutoController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return response()->json($produtoRepository->getResultadoPaginado(10), 200);
       /*
        $produtos = array();
    ...
    public function update(Request $request, $codbarras)
    {
        ...
        $produto->fill($request->all());  //codigo adicionado apos  a interface grafica

        //se for encaminhada imagem na requisição, antes deletamos a que se encontra arquivada.Para tanto, usamos a Facades Storage, importando-a antes 
        ...
        /* Funciona muito bem para o metodo put, mas para o patch, nao. Isolado após criar atualizar grafico
        $imagem = $request->file('imagem');
        $imagem_urn = $imagem->store('imagens','public');
    ...
    {
        $this->authorize('is_admin'); //bloqueou para admin e nao admin, rs
